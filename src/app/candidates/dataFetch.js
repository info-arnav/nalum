...
import Readalum from "../recruitment/Readalum.js";
  ...
  return (
    <>
      {loading ? (
        ...
        <>
          <div className="xl:grid xl:grid-cols-5 xl:divide-x divide-y gap-2">
            <div
              className="recruitment-grid gap-2.5 mb-[40px] col-span-2 overflow-x-scroll xl:overflow-x-hidden max-w-screen xl:overflow-y-scroll xl:h-[calc(100vh-80px)] xl:min-h-[400px] xl:block flex flex-row whitespace-nowrap xl:bg-white bg-[#f9f9f9]"
