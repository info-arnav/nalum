...
export default function Delete({
  ...
  return (
    <>
      <button
        className="bg-[#00183F] border-2 text-white rounded-full w-10 h-10 font-bold text-3xl hover:bg-[#084a8d] mx-2 grid content-center justify-center"
